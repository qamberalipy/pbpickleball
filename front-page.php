...
$reviews_query = new WP_Query(array(
    ...
    'posts_per_page' => 10, // Limit to 10 most recent for the carousel
    'orderby'        => 'date',
    'order'          => 'DESC'
));
...
if ( $reviews_query->have_posts() ) :
    while ( $reviews_query->have_posts() ) : $reviews_query->the_post(); 
        ...
        <div class="t-card">
            ...
            <span class="t-author">- <?php echo esc_html($reviewer_name ? $reviewer_name : get_the_title()); ?></span>
        </div>
    ...
    <div class="t-card">
        ...
        <span class="t-author">- The PBA Team</span>
    </div>
<?php endif; ?>
                </div>
            </div>
